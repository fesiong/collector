...
CREATE TABLE `fe_article` (
  ...
  KEY `views` (`views`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=5523 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `fe_article_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3212 DEFAULT CHARSET=utf8mb4 COMMENT='各地政策';
...
) ENGINE=InnoDB AUTO_INCREMENT=16772 DEFAULT CHARSET=utf8mb4;
